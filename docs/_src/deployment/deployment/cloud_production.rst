...
.. tabs:: 
   ...
   .. group-tab:: ``flyte-binary`` on EKS using NGINX
      ...
      .. rli:: https://raw.githubusercontent.com/flyteorg/flyte/master/charts/flyte-binary/eks-starter.yaml
   ...
   .. group-tab:: ``flyte-core`` on GCP using NGINX  
      ...
      .. rli:: https://raw.githubusercontent.com/flyteorg/flyte/master/charts/flyte-core/values-gcp.yaml        
