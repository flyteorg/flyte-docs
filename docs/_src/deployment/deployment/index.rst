...
.. dropdown:: ``flyte-binary``: chart for the **Single Cluster** option.
   ...
   .. rli:: https://raw.githubusercontent.com/flyteorg/flyte/master/charts/flyte-binary/Chart.yaml
      :language: yaml
      :caption: charts/flyte-binary/Chart.yaml

.. dropdown:: ``flyte-core``: chart for the **Multiple Cluster** option.

   .. rli:: https://raw.githubusercontent.com/flyteorg/flyte/master/charts/flyte-core/Chart.yaml
      :language: yaml
...
.. dropdown:: ``flyte-deps``: chart that installs additional useful dependencies alongside Flyte.
   ...
   .. rli:: https://github.com/flyteorg/flyte/blob/master/charts/flyte-deps/Chart.yaml
      :language: yaml
...
.. dropdown:: ``flyte``: chart that depends on ``flyte-core``, installing additional dependencies to Flyte deployment.
   ...
   .. rli:: https://raw.githubusercontent.com/flyteorg/flyte/master/charts/flyte/Chart.yaml
      :language: yaml
